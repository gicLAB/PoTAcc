  ...
  while (1) {
    ...
    if (load_wgt) {
      ...
      for (int i = 0; i < wp.wgt_size; i++) {
        ...
        // cout << (int)data1.range(2, 0) << " " << (int)data1.range (6, 4) << "
        // " << (int)data1.range(10, 8) << " " << (int)data1.range(14, 12) << "
        // " << (int)data1.range(18, 16) << " " << (int)data1.range(22, 20) << "
        // " << (int)data1.range(26, 24) << " " << (int)data1.range(30, 28) <<
        // endl;

        // cout << (int)data2.range(2, 0) << " " << (int)data2.range (6, 4) << "
        // " << (int)data2.range(10, 8) << " " << (int)data2.range(14, 12) << "
        // " << (int)data2.range(18, 16) << " " << (int)data2.range(22, 20) << "
        // " << (int)data2.range(26, 24) << " " << (int)data2.range(30, 28) <<
        // endl;

        // cout << (int)data3.range(2, 0) << " " << (int)data3.range (6, 4) << "
        // " << (int)data3.range(10, 8) << " " << (int)data3.range(14, 12) << "
        // " << (int)data3.range(18, 16) << " " << (int)data3.range(22, 20) << "
        // " << (int)data3.range(26, 24) << " " << (int)data3.range(30, 28) <<
        // endl;

        // cout << (int)data4.range(2, 0) << " " << (int)data4.range (6, 4) << "
        // " << (int)data4.range(10, 8) << " " << (int)data4.range(14, 12) << "
        // " << (int)data4.range(18, 16) << " " << (int)data4.range(22, 20) << "
        // " << (int)data4.range(26, 24) << " " << (int)data4.range(30, 28) <<
        // endl;
