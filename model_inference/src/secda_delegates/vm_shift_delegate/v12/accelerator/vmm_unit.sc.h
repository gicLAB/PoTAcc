...
// Signals
  ...
  // Memory
  ACC_DTYPE<URAM_DATAWIDTH> inp_1a_1[INP_BUF_LEN];
  ACC_DTYPE<URAM_DATAWIDTH> inp_1b_1[INP_BUF_LEN];

  ACC_DTYPE<URAM_DATAWIDTH> wgt_data1a[WGT_BUF_LEN];
  ...
  sc_int<PROD_DATA_WIDTH> mul_lut(sc_int<4>, sc_int<8>);

  sc_int<16> mul_s8_dsp(sc_int<8>, sc_int<8>);
  sc_int<64> mul_s64(int, sc_int<64>);

  void VM_PE_URAM(ACC_DTYPE<URAM_DATAWIDTH> *, ACC_DTYPE<URAM_DATAWIDTH> *,
                  ACC_DTYPE<URAM_DATAWIDTH> *, ACC_DTYPE<32> *, ACC_DTYPE<32> *,
...
#ifdef ENABLE_URAM
#pragma HLS RESOURCE variable = inp_1a_1 core = XPM_MEMORY uram
#pragma HLS RESOURCE variable = inp_1b_1 core = XPM_MEMORY uram
#pragma HLS RESOURCE variable = wgt_data1a core = XPM_MEMORY uram
#endif
