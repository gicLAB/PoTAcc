...
SC_MODULE(ACCNAME) {
  ...
  ClockCycles *compute_test = new ClockCycles("compute_test", true);
  ...
  std::vector<Metric *> profiling_vars = {compute_test};
  // std::vector<Metric *> profiling_vars = {gmSA, gmSB, gmSC, gmSD};
