...
void pre_load_wgt_toDMA(vector<int8_t> &wb0, vector<int8_t> &wb1,
  ...
  // std::cout << "pre_load_wgt_toDMA: width: " << width << " depth: " << depth
  //           << " rwidth: " << rwidth << " rdepth: " << rdepth
  //           << " dataSize: " << dataSize
  //           << " dataSizeEachBuff: " << dataSizeEachBuff << std::endl;
  ...
  // std::cout << "conv_layer_no: " << t->conv_layer_no
  //           << " layer_wgt_offsets: " <<
